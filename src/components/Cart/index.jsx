...
export default function Cart({cartItems, handleCheckou}) {
      ...
      <h2 className='text-2xl font-bold mb-5'>Giỏ hàng của bạn</h2>
      {
        ...
        <>
          <div>
            ...
            <button onClick={() => {handleCheckou() }}className='mt-5 bg-red-500 text-white font-semibold px-4 py-2 rounded-md'>Thanh toán</button>
            </div>
          </div>
        </> 
          : 
        <>
          <div className='text-x1 mb-2'>
